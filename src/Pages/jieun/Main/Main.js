...
import "./Main.scss";
import travel from "../../../images/jieun/travel.jpg"
...
class Main extends React.Component {
  ...
  <div className='main'>
    ...
    <div className='feeds'>
     <article> 
        <img src={travel} alt="asd" classNname="feedImage" />
         <div className='Container'>
            <div className='commentEmoticons'>
              ...
              <p>
                <span className ='otherUserName'>lisa0615</span>
                님 외 4명이 좋아합니다.
                <p>
        ...
        <div className='commentContainer'>            
            <input onKeyPress={this.handleKeypress} value={this.state.comment} onChange={this.handleAllInput} type="text" name='comment' placeholder="댓글 달기..." />
            <button onClick={this.handleSubmit}  className ="btn">게시</button>
       </div>
      </div>
      </article> 
    </div>
